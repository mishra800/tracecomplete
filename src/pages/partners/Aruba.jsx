...
export default function Aruba() {
  ...
  useEffect(() => {
    ...
    const track = document.querySelector('.aruba-carousel-track');
    const dots = document.querySelectorAll('.aruba-dot');
    const prevBtn = document.querySelector('.aruba-carousel-prev');
    const nextBtn = document.querySelector('.aruba-carousel-next');
    ...
    return () => {
      dots.forEach((dot, index) => {
        dot.removeEventListener('click', () => setCurrentSlide(index));
      });
  ...
  // Use case data for the slider
  const useCases = [
    {
      id: 'defence',
      category: 'DEFENCE',
      icon: 'fas fa-shield-alt',
      title: 'Defence Sector (High-Security Network Infrastructure)',
      description: 'Problem: Defence environments require highly secure, isolated, and policy-driven network access.',
      image: '/assets/images/use-cases/usecase1.png',
      linkTo: '/case-studies#aruba-defence'
    },
    {
      id: 'education',
      category: 'EDUCATION',
      icon: 'fas fa-graduation-cap',
      title: 'Education Sector (Campus-Wide Connectivity)',
      description: 'Problem: Need seamless, high-density, and secure connectivity for students, faculty, and guests.',
      image: '/assets/images/use-cases/usecase2.png',
      linkTo: '/case-studies#aruba-education'
    },
    {
      id: 'retail',
      category: 'RETAIL',
      icon: 'fas fa-shopping-cart',
      title: 'Shopping / Retail Sector (Multi-Store Network Management)',
      description: 'Problem: Retail chains need secure and centralized networking for POS, staff, and customers.',
      image: '/assets/images/use-cases/usecase3.png',
      linkTo: '/case-studies#aruba-retail'
    },
    {
      id: 'banking',
      category: 'BANKING',
      icon: 'fas fa-university',
      title: 'Banking Sector (Secure & Compliant Networking)',
      description: 'Problem: Banks require strict access control, segmentation, and compliance-ready networks.',
      image: '/assets/images/use-cases/usecase4.png',
      linkTo: '/case-studies#aruba-banking'
    },
    {
      id: 'healthcare',
      category: 'HEALTHCARE',
      icon: 'fas fa-hospital',
      title: 'Healthcare Sector (Hospital Network Infrastructure)',
      description: 'Problem: Hospitals need secure connectivity for medical devices, staff, and patient systems.',
      image: '/assets/images/use-cases/usecase5.png',
      linkTo: '/case-studies#aruba-healthcare'
    },
    {
      id: 'enterprise',
      category: 'ENTERPRISE',
      icon: 'fas fa-building',
      title: 'Large-Scale Enterprises (High-Performance Networks)',
      description: 'Problem: Enterprises require scalable, high-performance, and centrally managed networks.',
      image: '/assets/images/use-cases/usecase6.png',
      linkTo: '/case-studies#aruba-enterprise'
    },
    {
      id: 'manufacturing',
      category: 'MANUFACTURING',
      icon: 'fas fa-industry',
      title: 'Manufacturing Industry (Smart Factory & Industrial Networking)',
      description: 'Problem: Manufacturing environments require secure, reliable connectivity for machines, IoT devices, production lines, and real-time monitoring systems.',
      image: '/assets/images/use-cases/usecase7.png',
      linkTo: '/case-studies#aruba-manufacturing'
    }
  ];
    ...
    <div className="aruba-page">
      ...
      />
          ...
          <section className="aruba-hero-new">
            <div className="aruba-hero-bg-new"></div>
            <div className="container">
              <div className="aruba-hero-content-new">
                {/* Hero Top Grid: Text and Image side by side */}
                <div className="aruba-hero-top-grid">
                  {/* Title Section - Left */}
                  <div className="aruba-hero-title-section">
                    <div className="aruba-badge-new">HPE ARUBA GOLD PARTNER</div>
                    <h1 className="aruba-hero-main-title">
                      Leading HPE Aruba<br />
                      <span className="aruba-gold-text">Gold Partner</span><br />
                      in Hyderabad
                    </h1>
                    <p className="aruba-hero-subtitle">Helping Businesses Build Faster, More Secure Networks.</p>
                  </div>

                  {/* Hero Image Section - Right */}
                  <div className="aruba-hero-image-section">
                    <img 
                      src="/assets/images/aruba/aruba_hero_device.png?v=2" 
                      alt="HPE Aruba Security Device" 
                      className="aruba-hero-device-img" 
                    />
                  </div>
                </div>
              </div>
            ...
            {/* Empowering Digital Transformation Card - Full Width Below */}
            <div className="container" style={{ marginTop: '60px' }}>
              <div className="aruba-transformation-card">
                <div className="aruba-transform-header">
                  <div className="aruba-transform-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="56" height="56" fill="none">
                      <path d="M 22,38 C 17.5,38 14,34.5 14,30 C 14,25.8 17.2,22.4 21.3,22.0 C 23.0,15.5 29.0,11 36,11 C 44.5,11 51.5,17.5 52.0,26 C 56.5,26.5 60,30.2 60,35 C 60,40 56,43 51,43" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M 26,43 L 26,48 L 20,48" stroke="#ff8300" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                      <circle cx="17" cy="48" r="2.5" fill="#ff8300" />
                      <path d="M 34,43 L 34,53" stroke="#ff8300" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                      <circle cx="34" cy="56" r="2.5" fill="#ff8300" />
                      <path d="M 42,43 L 42,50 L 48,50" stroke="#ff8300" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                      <circle cx="51" cy="50" r="2.5" fill="#ff8300" />
                    </svg>
                  </div>
                  <div className="aruba-transform-title-wrap">
                    <h2 className="aruba-transform-title">
                      Empowering Digital Transformation with <span className="aruba-highlight-text">Aruba Networking</span>
                    </h2>
                    <p className="aruba-transform-subtitle">Secure, Intelligent, and Cloud-Managed Network Solutions</p>
                  </div>
                </div>

                <div className="aruba-features-grid">
                  <div className="aruba-feature-item">
                    <div className="aruba-feature-icon-wrapper">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="44" height="44" fill="none">
                        <path d="M 16,24 L 16,16 L 24,16" stroke="#ff8300" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M 48,16 L 48,24" stroke="#ff8300" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M 40,16 L 48,16" stroke="#ff8300" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M 16,40 L 16,48 L 24,48" stroke="#ff8300" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M 48,40 L 48,48 L 40,48" stroke="#ff8300" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M 18,32 C 22,23 30,19 32,19 C 34,19 42,23 46,32 C 42,41 34,45 32,45 C 30,45 22,41 18,32 Z" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        <circle cx="32" cy="32" r="6" stroke="#ff8300" strokeWidth="2.5" fill="none" />
                        <circle cx="32" cy="32" r="2.5" fill="#ff8300" />
                      </svg>
                    </div>
                    <div className="aruba-feature-content">
                      <h3 className="aruba-feature-number">24*7</h3>
                      <h4 className="aruba-feature-title">Network Visibility</h4>
                      <p className="aruba-feature-desc">Gain complete visibility into your network, anytime, anywhere.</p>
                    </div>
                  </div>
                  ...
                  <div className="aruba-feature-item">
                    <div className="aruba-feature-icon-wrapper">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="44" height="44" fill="none">
                        <rect x="12" y="16" width="40" height="26" rx="4" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M 24,42 L 20,49 C 20,49 26,49 32,49 C 38,49 44,49 44,49 L 40,42" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M 16,29 L 22,29 L 25,21 L 29,35 L 33,26 L 36,29 L 42,29" stroke="#ff8300" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        <circle cx="44" cy="38" r="5.5" stroke="#ff8300" strokeWidth="2.5" fill="#0b1329" />
                        <path d="M 48,42 L 53,47" stroke="#ff8300" strokeWidth="2.5" strokeLinecap="round" />
                      </svg>
                    </div>
                    <div className="aruba-feature-content">
                      <h3 className="aruba-feature-number">Realtime</h3>
                      <h4 className="aruba-feature-title">Monitoring and Insights</h4>
                      <p className="aruba-feature-desc">Detect issues faster and make data-driven decisions.</p>
                    </div>
                  </div>
                  ...
                  <div className="aruba-feature-item">
                    <div className="aruba-feature-icon-wrapper">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="44" height="44" fill="none">
                        <path d="M 20,38 C 15.5,38 12,34.5 12,30 C 12,25.8 15.2,22.4 19.3,22.0 C 21.0,15.5 27.0,11 34,11 C 42.5,11 49.5,17.5 50.0,26 C 54.5,26.5 58,30.2 58,35 C 58,40 54,43 49,43 L 36,43" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        <g transform="translate(32, 30)">
                          <circle cx="0" cy="0" r="5" stroke="#ff8300" strokeWidth="2.5" />
                          <path d="M 0,-5 L 0,-8 M 0,5 L 0,8 M -5,0 L -8,0 M 5,0 L 8,0 M -3.5,-3.5 L -6,-6 M 3.5,3.5 L 6,6 M -3.5,3.5 L -6,6 M 3.5,-3.5 L 6,-6" stroke="#ff8300" strokeWidth="2.5" strokeLinecap="round" />
                        </g>
                      </svg>
                    </div>
                    <div className="aruba-feature-content">
                      <h3 className="aruba-feature-number">100%</h3>
                      <h4 className="aruba-feature-title">Centralized Management</h4>
                      <p className="aruba-feature-desc">Single-pane-of-glass administration with Aruba Central.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="aruba-certifications">
            <div className="container">
              <div className="aruba-section-header" data-aos="fade-up">
                ...
                <p>Aruba-certified professionals delivering proven expertise across networking and security solutions</p>
              </div>
              <div className="aruba-cert-slider-wrapper">
                <div className="aruba-cert-images">
                  <div className="aruba-cert-img-card">
                    <img src="/assets/images/aruba/image1.png" alt="Accredited SD-WAN Professional" title="Accredited SD-WAN Professional" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">Accredited SD-WAN Professional</span>
                  </div>
                  <div className="aruba-cert-img-card">
                    <img src="/assets/images/aruba/image2.png" alt="Aruba Certified Switching Professional (ACSP)" title="Aruba Certified Switching Professional (ACSP)" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">Aruba Certified Switching Professional (ACSP)</span>
                  </div>
                  <div className="aruba-cert-img-card">
                    <img src="/assets/images/aruba/image3.png" alt="Aruba HPE Sales Certified Networking Solutions Professional" title="Aruba HPE Sales Certified Networking Solutions Professional" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">Aruba HPE Sales Certified Networking Solutions Professional</span>
                  </div>
                  <div className="aruba-cert-img-card">
                    <img src="/assets/images/aruba/image4.png" alt="HPE Aruba Networking Certified Campus Access Professional" title="HPE Aruba Networking Certified Campus Access Professional" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">HPE Aruba Networking Certified Campus Access Professional</span>
                  </div>
                  <div className="aruba-cert-img-card">
                    <img src="/assets/images/aruba/image5.png" alt="HPE Aruba Networking Certified Network Security Associate" title="HPE Aruba Networking Certified Network Security Associate" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">HPE Aruba Networking Certified Network Security Associate</span>
                  </div>
                  <div className="aruba-cert-img-card">
                    <img src="/assets/images/aruba/image6.png" alt="HPE Aruba Networking Certified Network Security Associate" title="HPE Aruba Networking Certified Network Security Associate" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">HPE Aruba Networking Certified Network Security Associate</span>
                  </div>
                  <div className="aruba-cert-img-card">
                    <img src="/assets/images/aruba/image7.png" alt="HPE Aruba Networking Accredited Central Product Specialist" title="HPE Aruba Networking Accredited Central Product Specialist" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">HPE Aruba Networking Accredited Central Product Specialist</span>
                  </div>
                  <div className="aruba-cert-img-card">
                    <img src="/assets/images/aruba/image8.png" alt="HPE Aruba Networking Accredited CX 10000 Switch Product Specialist" title="HPE Aruba Networking Accredited CX 10000 Switch Product Specialist" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">HPE Aruba Networking Accredited CX 10000 Switch Product Specialist</span>
                  </div>
          ...
          <section 
            ...
            style={{
              backgroundImage: 'linear-gradient(rgba(0, 8, 20, 0.75), rgba(5, 15, 30, 0.85)), url(/assets/images/bggg.jpg)',
          ...
          {/* Use Cases - New Professional Slider */}
          ...
          <section className="threat-map-section">
            <div className="threat-map-container">
              <div className="threat-map-header">
                <h2 className="threat-map-title">Keep One Step Ahead of Cyber Threats</h2>
                <p className="threat-map-subtitle">Real-time insight into global attacks, vulnerabilities, and risks.</p>
                <div className="threat-map-cta">
                  <a href="/contact-us" className="threat-map-btn">
              ...
              <div className="world-map-wrapper">
                <svg className="world-map-svg" viewBox="30.767 241.591 784.077 458.627" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
                  <defs>
                    {/* Glow filter for threat points */}
                    ...
                    <pattern id="dotMapPattern" width="6" height="6" patternUnits="userSpaceOnUse">
                      <rect width="6" height="6" fill="rgba(255, 255, 255, 0.025)" />
                      <circle cx="2.5" cy="2.5" r="1.1" fill="rgba(255, 255, 255, 0.55)" />
                    </pattern>
                    
                    <pattern id="dotMapPatternHover" width="6" height="6" patternUnits="userSpaceOnUse">
                      <rect width="6" height="6" fill="rgba(255, 131, 0, 0.1)" />
                      <circle cx="2.5" cy="2.5" r="1.3" fill="rgba(255, 131, 0, 0.95)" />
                    </pattern>
                  </defs>
...
<path className="mainland" d="M213.986,529.43l-4.088,2.541l-0.294,3.771l-0.821,1.234l2.576,2.473l-1.115,1.219l0.259,3.113l4.607,1.098l6.976-8.256l-0.017-2.878l-3.345-0.216L213.986,529.43L213.986,529.43z"/>
    ...
    <g id="ee">
        <path className="mainland" d="M462.562,363.299l-4.84-0.173l-3.068,1.875l-0.043,1.392l1.987,1.875l6.182,1.047L462.562,363.299L462.562,363.299z"/>
    ...
    <g id="es">
        <path className="mainland" d="M402.565,416.322h-11.014l-2.222-1.004l-1.071,0.078l-1.297,2.696l0.458,2.775l4.21,0.389l0.536,1.771l-1.833,10.33l0.078,1.851l2.981,1.617l3.439,0.232l6.881-1.694l3.363-4.233l0.077-4.313l5.965-5.395l0.302-2.386l-5.428-0.078L402.565,416.322L402.565,416.322z"/>
...
<path className="mainland" d="M400.629,367.984l-1.582,2.395l0.631,0.959h3.648v1.6l-0.952,1.278l0.632,3.354l2.058,3.994l1.581,3.672l2.533,0.959l1.105,1.92l-0.155,1.755l-1.582,0.959l-0.156,0.795l1.106,0.64l-0.951,1.279l-2.221,0.959l-4.279-0.477l-6.664,3.035l-2.221-1.115l6.345-3.674l-0.796-0.477l-3.328-0.32l2.058-3.033l0.319-2.56l2.696-0.319l-0.475-4.953l-3.174-0.155l-0.95-1.115l0.155-3.674l-1.901,0.156l1.901-6.388l3.492-2.56L400.629,367.984L400.629,367.984z"/>
    ...
    <g id="gr">
        <path className="mainland" d="M453.004,427.213l-0.096,1.15l4.003,2.014l1.911,0.734l-1.003,1.055l-2.23,0.227l-0.319,1.01l0.771,1.738l2.498,1.33l1.09,0.096l0.138-2.981l1.635-1.972l-4.46-5.272l0.589-1.789l1.046-0.043l1.591,1.279l1.002-0.501l0.319-1.79l3.732,0.534l1.134-3.239l-1.953,1.375l-5.731-0.14l-3.726,1.929L453.004,427.213L453.004,427.213z"/>
...
<path id="mm" d="M645.533,501.596l-2.396-3.838l1.737-2.438l-1.642-3.018l-1.548-0.294l-0.294-5.064l-2.316-4.486l-0.675,1.071l-1.547,2.628l-1.937,0.294l-0.968-1.271l-0.484-3.414l-1.453-2.73l-5.913-5.576l1.453-0.959l0.27-4.037l2.16-3.631l0.935-9.032l3.129-2.136l0.103-3.293l1.877,0.622l2.956,4.279l-2.194,4.701l1.479,3.691l3.655,1.435l0.666,4.021l4.91,0.761l-1.357,2.343l-6.188,2.438l-0.674,3.993l4.547,5.844l0.189,3.12l-1.062,1.072l0.094,0.977l3.389,4.971l0.096,5.16L645.533,501.596L645.533,501.596z"/>
    ...
    <g id="my">
        <path className="mainland" d="M648.359,511.796l1.736,3.898l0.391,5.064l2.324,3.604l5.096,3.083l1-0.791l1.464-0.288l-0.212-1.91l-1.841-4.478l-2.697-5.731l-0.227,1.003l-3.25-0.146l-2.334-3.354L648.359,511.796L648.359,511.796z"/>
...
<path id="nl" d="M421.349,384.572l-3.915,1.928l0.829,0.752l0.088,1.928l-0.829-0.164l-0.917-1.426l-2.188,3.467l3.363,0.699l1.253,1.323l0.666,0.017l0.44-2.99l2.117-0.891L421.349,384.572L421.349,384.572z"/>
    ...
    <g id="pg">
        <path className="mainland" d="M752.132,540.183l-0.319,21.126l3.044-0.164l4.002-4.676l3.361,0.164l2.161,1.937l0.718,5.964l6.882,3.631l1.763-0.648v-2.179l-5.523-4.599l-2.723-6.293l2.161-1.047l-1.601-3.466l-3.197-0.078l-0.805-3.709l-8.479-5.722L752.132,540.183L752.132,540.183z"/>
...
<path d="M699.074,475.076l-2.23,1.581l-0.25,4.997l3.477,6.742l1.158,0.915l1.485-1.003l2.56,0.415l0.492,2.248l1.901,0.164l0.908-1.245l-1.158-1.582l-1.409-1.331l-2.974-0.327l-1.573-2.585l1.816-2.749l0.163-2.411l-1.236-3.077L699.074,475.076L699.074,475.076z"/>
    ...
    <g id="pt">
        <path className="mainland" d="M387.499,421.716l-0.536,7.478l-1.53,1.384l0.156,0.846l1.071,1.772l-0.691,2.16l1.149,0.39l2.68-0.312l-0.155-2.16l1.756-10.02l-0.382-1.383L387.499,421.716L387.499,421.716z"/>
...
<path d="M563.855,254.809l-1.938-1.203h-2.23l-0.448,1.35l-2.377,1.35l-1.79,0.596l-0.294,1.798l4.167,0.303L563.855,254.809L563.855,254.809z"/>
    ...
    <g id="se">
        <path className="mainland" d="M445.232,329.52l1.693,1.563h3.173l1.746,3.354l0.477,5.748l-4.278,3.035v3.033l-3.017,4.158l-1.746,0.154l-2.378,3.994l0.155,3.838l4.124,3.035l-0.319,1.754l-1.582,2.396l-2.377,2.074l0.155,6.872l-3.647,1.279l-1.271,2.713h-1.747l-0.949-4.789l-3.969-6.084l3.26-5.455l0.225-13.477l2.248-1.236l0.545-7.709l6.405-9.172L445.232,329.52L445.232,329.52z"/>
...
<path id="ve" d="M231.5,503.558l0.38,2.239l2.809,0.892l0.64-4.124l2.965-3.068l2.965,3.475l6.82,1.859l5.774-1.211l3.933,4.849l2.965,1.858l-3.25,4.953l1.089,3.752l-1.858,2.299l-1.928,1.616l-4.175-2.102l-0.959,0.969v2.99l3.052,1.452l-2.248,2.43l-2.248,2.43l-2.965-0.242l-2.982-3.275l-0.631-12.326l-10.183-3.476l-1.85-5.42L231.5,503.558L231.5,503.558z"/>
    ...
    <g id="ye">
        <path className="mainland" d="M509.432,489.131l1.244,3.7v3.613l2.991,2.714l21.074-8.584l0.198-2.359l-3.381-6.067l-8.479,2.706l-4.866,4.787l-5.645-3.336L509.432,489.131L509.432,489.131z"/>
    ...
    <path id="zw" d="M468.52,578.226l7.755,8.757l5.946,1.513l3.984-6.248l-0.312-8.281l-6.465-3.337l-2.431,1.098l-3.62,5.524l-5.014-0.053L468.52,578.226L468.52,578.226z"/>
                  ...
                  <g className="connection-lines">
                    ...
                    <path 
                      d="M 180 370 Q 300 320, 420 380" 
                      className="threat-line-dashed" 
                      stroke="rgba(255, 131, 0, 0.15)" 
                      strokeWidth="1.5" 
                      fill="none" 
                      strokeDasharray="6 4"
                    />
                    <path 
                      d="M 180 370 Q 300 320, 420 380" 
                      className="attack-path-flow" 
                      fill="none" 
                      style={{ animationDelay: '0s', animationDuration: '3s' }}
                    />

                    {/* Line 2: North America to East Asia */}
                    <path 
                      d="M 180 370 Q 410 280, 640 410" 
                      className="threat-line-dashed" 
                      stroke="rgba(255, 131, 0, 0.15)" 
                      strokeWidth="1.5" 
                      fill="none" 
                    ...
                    {/* Line 3: East Asia to Australia */}
                    <path 
                      d="M 640 410 Q 685 515, 730 620" 
                      className="threat-line-dashed" 
                      stroke="rgba(255, 131, 0, 0.15)" 
                      strokeWidth="1.5" 
                      fill="none" 
                    ...
                    {/* Line 4: North America to South America */}
                    <path 
                      d="M 180 370 Q 220 450, 260 540" 
                      className="threat-line-dashed" 
                      stroke="rgba(255, 131, 0, 0.15)" 
                      strokeWidth="1.5" 
                      fill="none" 
                    ...
                    {/* Line 5: Europe to East Asia */}
                    <path 
                      d="M 420 380 Q 530 395, 640 410" 
                      className="threat-line-dashed" 
                      stroke="rgba(255, 131, 0, 0.15)" 
                      strokeWidth="1.5" 
                      fill="none" 
                  ...
                  {/* Threat Points with Glow */}
                  <g className="threat-points">
                    {/* North America */}
                    <circle cx="180" cy="370" r="8" fill="#ff9933" filter="url(#glowFilter)" className="pulse-dot">
                      <animate attributeName="opacity" values="0.7;1;0.7" dur="2.5s" repeatCount="indefinite" />
                    </circle>

                    {/* South America */}
                    <circle cx="260" cy="540" r="8" fill="#ff6699" filter="url(#glowFilter)" className="pulse-dot">
                      <animate attributeName="opacity" values="0.7;1;0.7" dur="3s" repeatCount="indefinite" />
                    </circle>

                    {/* Europe */}
                    <circle cx="420" cy="380" r="8" fill="#ffdd44" filter="url(#glowFilter)" className="pulse-dot">
                      <animate attributeName="opacity" values="0.7;1;0.7" dur="2.2s" repeatCount="indefinite" />
                    </circle>

                    {/* Africa */}
                    <circle cx="460" cy="500" r="8" fill="#ff9933" filter="url(#glowFilter)" className="pulse-dot">
                      <animate attributeName="opacity" values="0.7;1;0.7" dur="3.2s" repeatCount="indefinite" />
                    </circle>

                    {/* East Asia */}
                    <circle cx="640" cy="410" r="8" fill="#66ff99" filter="url(#glowFilter)" className="pulse-dot">
                      <animate attributeName="opacity" values="0.7;1;0.7" dur="2.8s" repeatCount="indefinite" />
                    </circle>

                    {/* India */}
                    <circle cx="595" cy="480" r="8" fill="#66ccff" filter="url(#glowFilter)" className="pulse-dot">
                      <animate attributeName="opacity" values="0.7;1;0.7" dur="2.4s" repeatCount="indefinite" />
                    </circle>

                    {/* Indicators */}
                    <circle cx="440" cy="450" r="5" fill="none" stroke="#888" strokeWidth="1.5" opacity="0.6">
                      <animate attributeName="r" values="5;9;5" dur="3s" repeatCount="indefinite" />
                    </circle>
                    
                    <circle cx="560" cy="470" r="3.5" fill="#ff5555" opacity="0.7">
          ...
          {/* Products & POC Section - Redesigned with Auto-Sliding Carousel */}
          <section className="aruba-products-poc-section">
            <div className="container">
              <div className="aruba-products-poc-grid">
                {/* Left Side - Auto-Sliding Product Carousel */}
                <div className="aruba-products-carousel-container">
                  <div className="aruba-carousel-wrapper">
                    <div className="aruba-carousel-track">
                      {/* Slide 1 - Aruba NAC */}
                      <div className="aruba-carousel-slide">
                        <div className="aruba-carousel-image-box">
                          <img src="/assets/images/aruba/1.png" alt="Aruba NAC" className="aruba-carousel-img" />
                        </div>
                        <div className="aruba-carousel-info">
                          <h3 className="aruba-carousel-title">Aruba NAC</h3>
                          <p className="aruba-carousel-desc">High performance. Built for scale.</p>
                          <div className="aruba-carousel-underline"></div>
                        </div>
                      </div>

                      {/* Slide 2 - Aruba Switches */}
                      <div className="aruba-carousel-slide">
                        <div className="aruba-carousel-image-box">
                          <img src="/box2.png" alt="Aruba Switches" className="aruba-carousel-img" />
                        </div>
                        <div className="aruba-carousel-info">
                          <h3 className="aruba-carousel-title">Aruba Switches</h3>
                          <p className="aruba-carousel-desc">Reliable connectivity. Simplified.</p>
                          <div className="aruba-carousel-underline"></div>
                        </div>
                      </div>

                      {/* Slide 3 - Aruba Access Points */}
                      <div className="aruba-carousel-slide">
                        <div className="aruba-carousel-image-box">
                          <img src="/assets/images/aruba/1 (2).png" alt="Aruba Access Points" className="aruba-carousel-img" />
                        </div>
                        <div className="aruba-carousel-info">
                          <h3 className="aruba-carousel-title">Aruba Access Points</h3>
                          <p className="aruba-carousel-desc">Secure access. Seamless experience.</p>
                          <div className="aruba-carousel-underline"></div>
                        </div>
                      </div>

                      {/* Slide 4 - Aruba Central Management */}
                      <div className="aruba-carousel-slide">
                        <div className="aruba-carousel-image-box">
                          <img src="/box44.png" alt="Aruba Central Management" className="aruba-carousel-img" />
                        </div>
                        <div className="aruba-carousel-info">
                          <h3 className="aruba-carousel-title">Aruba Central Management</h3>
                          <p className="aruba-carousel-desc">AI-powered. Cloud-managed.</p>
                          <div className="aruba-carousel-underline"></div>
                        </div>
                      </div>

                      {/* Slide 5 - Aruba Outdoor Access Points */}
                      <div className="aruba-carousel-slide">
                        <div className="aruba-carousel-image-box">
                          <img src="/product-access-points-outdoor.jpeg" alt="Aruba Outdoor Access Points" className="aruba-carousel-img" />
                        </div>
                        <div className="aruba-carousel-info">
                          <h3 className="aruba-carousel-title">Aruba Outdoor Access Points</h3>
                          <p className="aruba-carousel-desc">Weather-resistant. Enterprise-grade performance.</p>
                          <div className="aruba-carousel-underline"></div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="aruba-carousel-dots">
                    <span className="aruba-dot active" data-slide="0"></span>
                    <span className="aruba-dot" data-slide="1"></span>
                    <span className="aruba-dot" data-slide="2"></span>
                    <span className="aruba-dot" data-slide="3"></span>
                    <span className="aruba-dot" data-slide="4"></span>
                  </div>

                  {/* Carousel Navigation Arrows */}
                  <button className="aruba-carousel-arrow aruba-carousel-prev" aria-label="Previous slide">
                    <i className="fas fa-chevron-left"></i>
                  </button>
                  <button className="aruba-carousel-arrow aruba-carousel-next" aria-label="Next slide">
                ...
                <div className="aruba-poc-offer-box">
                  <div className="aruba-poc-header">
                    ...
                    <p className="aruba-poc-tagline">EXCLUSIVE OFFERS ON ARUBA NETWORKING SOLUTIONS</p>
                  </div>
                  
                  <p className="aruba-poc-intro-text">
                    Experience the power of Aruba networking firsthand - zero risk, zero commitment. 
                  ...
                  <div className="aruba-poc-benefits-grid">
                    ...
                    <div className="aruba-benefit-item">
                      ...
                      <div className="aruba-benefit-text">
                        <h4>Tailored to your network</h4>
                    ...
                    <div className="aruba-benefit-item">
                      ...
                      <div className="aruba-benefit-text">
                        <h4>Exclusive pricing on Aruba solutions</h4>
                  ...
                  <p className="aruba-closing-text">
                    Let's build a <span className="aruba-highlight">smarter, stronger</span> network—together.
                  </p>
                </div>
              </div>
            </div>
